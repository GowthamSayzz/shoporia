        ...
        <div className="container shoporia-mt">
            <div id="autoCarousel" className="carousel slide" data-bs-ride="carousel" data-bs-interval="3000" data-bs-pause="false" >
                <div className="carousel-inner" style={{ aspectRatio: "211 / 35" }}>
                    ...
                    <div className="carousel-item">
                        <img src={banner2} className="d-block w-100 img-fluid" alt="Slide 2" />
                    </div>
                    <div className="carousel-item">
                    ...
                    <div className="carousel-item">
                        <img src={banner5} className="d-block w-100 img-fluid" alt="Slide 5" />
                    </div>
                    <div className="carousel-item">
                        <img src={banner6} className="d-block w-100 img-fluid" alt="Slide 6" />
                    </div>
                </div>
                                ...
                                {getPhones.reduce((rows, phone, index) => {
                                    ...
                                    <div key={i} className={`carousel-item ${i === 0 ? 'active' : ''}`}>
                                        <div className="d-flex flex-wrap justify-content-center mt-4">
                                            {group.map((phone, j) => (
                                                <div key={j} className="card me-3 mb-3" style={{ width: '200px' }}>
                                                    <img
                                                        src={phone.thumbnail}
                                                        className="card-img-top pt-3 product-card img-fluid"
                                                        alt={phone.title}
            ...
            <div className='container mt-3 shadow border'>
                <div className='row'>
                    ...
                    <div id="brandsCarousel" className="carousel slide mb-3" data-bs-interval="3000" data-bs-ride="carousel" data-bs-pause="false">
                        <div className="carousel-inner">
                            {[
                                [banner9, banner10, banner11, banner12],
                                [banner13, banner14, banner15, banner16],
                                [banner17, banner18, banner19, banner20]
                            ].map((group, i) => (
                                <div key={i} className={`carousel-item ${i === 0 ? 'active' : ''}`}>
            ...
            <div className='container mt-3'>
                <div className='row g-3'>
                    <div className='col-12 col-md-6'>
                        <img src={banner21} alt='images' className='img-fluid w-100 h-100' />
                    </div>
                    <div className='col-12 col-md-6'>
                        <img src={banner22} alt='images' className='img-fluid w-100 h-100' />
                    </div>
                </div>
            </div>
        </div>
